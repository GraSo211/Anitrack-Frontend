...
import Genres from '../anime/info/Genres'
import { FaFireAlt } from "react-icons/fa";
import { FaStar } from "react-icons/fa";
import buildTrailerUrl from '@/utils/buildTrailerUrl'
import Episodes from '../anime/info/Episodes'
import { EpisodePage } from '@/types/EpisodePage'
import AnimeStatus from '../anime/info/AnimeStatus'
...
export default function MobileSection({ anime, episodePage }: Props) {
    return (
        <div className="mt-4 flex flex-col  justify-center items-center col-span-1">
            {anime.coverImage && anime.coverImage.extraLarge && <Image src={anime.coverImage.extraLarge} alt={anime.title.romaji || "Desconocido"} width={300} height={500} priority className="rounded-xl shadow-xl border border-gray-800" />}
