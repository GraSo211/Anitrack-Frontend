        ...
        <div className="flex flex-col  w-full relative">
            ...
            <header className="">
                ...
                <div className="flex flex-wrap gap-3 items-center">
                    {averageScore && (
                        <span className="px-3 py-1 rounded bg-yellow-500/20 text-yellow-400 font-semibold">
                            ⭐ {averageScore}
                        </span>
                    )}
                    {popularity && (
                        <span className="px-3 py-1 rounded bg-orange-500/20 text-orange-400 font-semibold">
                            🔥 {popularity}
                        </span>
                    )}
                    ...
                    >
                        <div className="relative overflow-hidden rounded-xl border border-gray-700 shadow-lg">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <span className="bg-black/60 text-white px-4 py-2 rounded-full font-semibold">
                                    ▶ Ver trailer
                                </span>
                            </div>
                        </div>
