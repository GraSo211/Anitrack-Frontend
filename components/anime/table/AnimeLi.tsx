...
export default function AnimeLi({ coverImage, title, id, episode }: Props) {
    return (
        <li className="text-center relative flex flex-col items-center gap-1  m-2 bg-[#0d1b2a] text-pretty  h-[170px] 2xl:h-[230] overflow-hidden rounded-lg hover:scale-105 transition-transform shadow-lg shadow-black/30 duration-[500ms] ">
